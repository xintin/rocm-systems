...
#include "socket_generated.h"
#include "socket.grpc.fb.h"
...
namespace fb = mirage::socket;

class MirageDaemonService final : public fb::Daemon::Service {
public:
    MirageDaemonService(mirage::DashboardService& svc,
                           RunTracker& runs,
...
build_dispatch(MirageDaemonService& svc) {
